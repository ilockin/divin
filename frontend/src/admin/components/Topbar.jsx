...
export const Topbar = () => {
  const { me, role, switchRole, canSwitchRole } = useAdmin();
  ...
  return (
    <header className="bg-white border-b hairline px-6 lg:px-8 py-3 flex items-center gap-4 sticky top-0 z-30" data-testid="admin-topbar">
      ...
      <div className="flex items-center gap-2 ml-auto">
        {/* role switcher — só para super_admin */}
        {canSwitchRole && <div className="relative">
          <button
          ...
          {showUser && (
            <div className="absolute right-0 mt-2 w-56 bg-white border hairline rounded-xl shadow-lg p-2 z-40" data-testid="user-menu">
              ...
              <button
                ...
                className="w-full text-left px-3 py-2 rounded-lg font-body text-sm hover:bg-[var(--da-cream-2)]/60 flex items-center gap-2 text-red-700"
              >
